...
Uploader.prototype.uploadCustomContent = function(cookie, cb) {
    var self = this;
    var requestor = new Requestor(cookie, config.projectName);
...
Uploader.prototype.uploadAll = function(cookie, cb) {
    var self = this;
    self.uploadDocs(cookie, function() {
        self.uploadCustomPages(cookie, function() {
            self.uploadCustomContent(cookie, function(contentReg) {
                cb(contentReg);
            });
        });
    });
