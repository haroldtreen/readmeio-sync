    ...
    var recursiveRequest = function(resources) {
        ...
        uploadResource(resource, function(err, response, body) {
            if (err || response.statusCode !== 200) {
                ...
                if (resource.appearance && resource.appearance.html_body) {
                    fs.writeFileSync(resource.appearance.html_body, respBody.appearance.html_body);
                }
...
Requestor.prototype.uploadContent = function(resources, cb) {
    ...
    var createBodyFn = function(resource) {
        return JSON.stringify({
            appearance: {
                html_body: fs.readFileSync(resource.appearance.html_body).toString(),
