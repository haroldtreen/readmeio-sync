...
Requestor.prototype.documentation = function(resources, cb) {
    var self = this;
    var resourceToRequestConverter = this.buildResourceToGetRequestFn('documentation', RequestorFilters.documentation, 'docsUrl');
...
Requestor.prototype.customPages = function(resources, cb) {
    var self = this;
    var resourceToRequestConverter = this.buildResourceToGetRequestFn('customPages', RequestorFilters.pages, 'pagesUrl');
    var requestFns = resources.map(resourceToRequestConverter);
...
Requestor.prototype.customContent = function(resources, cb) {
    var self = this;
    var resourceToRequestConverter = this.buildResourceToGetRequestFn('customContent', RequestorFilters.content, 'contentUrl');
    var requestFns = resources.map(resourceToRequestConverter);
