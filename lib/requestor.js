...
Requestor.prototype.buildRecursiveDeleteRequestFn = function(urlFn, cb) {
    var resourceIdx = 0;
    var self = this;
    var failedResources = [];
...
Requestor.prototype.deleteDocs = function(resources, cb) {
    var recursiveRequest = this.buildRecursiveDeleteRequestFn('docsDeleteUrl', cb);
    recursiveRequest(resources);
};

Requestor.prototype.deletePages = function(resources, cb) {
    var recursiveRequest = this.buildRecursiveDeleteRequestFn('pagesDeleteUrl', cb);
    recursiveRequest(resources);
};
