...
Requestor.prototype.buildRecursiveUploadRequestFn = function(createBodyFn, urlFns, cb) {
    ...
    var uploadResource = function(resource, requestCb) {
        ...
        if (typeof resource.slug === 'undefined') {
            request.post({ url: urlGen[urlFns.post](resource.categorySlug), jar: self.cookie, body: createBodyFn(resource) }, requestCb);
        } else {
            request.put({ url: urlGen[urlFns.put](resource.slug), jar: self.cookie, body: createBodyFn(resource) }, requestCb);
        }
    };
