...
Requestor.prototype.documentation = function(resources, cb) {
    var self = this;
    var resourceToRequestConverter = this.buildResourceToGetRequestFn('documentation', RequestorFilters.documentation, 'docsGetUrl');
...
Requestor.prototype.customPages = function(resources, cb) {
    var self = this;
    var resourceToRequestConverter = this.buildResourceToGetRequestFn('customPages', RequestorFilters.pages, 'pagesGetUrl');
    var requestFns = resources.map(resourceToRequestConverter);
...
Requestor.prototype.customContent = function(resources, cb) {
    var self = this;
    var resourceToRequestConverter = this.buildResourceToGetRequestFn('customContent', RequestorFilters.content, 'contentGetUrl');
    var requestFns = resources.map(resourceToRequestConverter);
