...
UrlGenerator.prototype.docCategoriesDeleteUrl = function(slug) {
    return this.base() + this.docCategoriesDeletePath(slug);
};
...
UrlGenerator.prototype.docCategoriesOrderUrl = function() {
    return this.base() + this.docCategoriesOrderPath();
};
...
UrlGenerator.prototype.docsOrderUrl = function() {
    return this.base() + this.docsOrderPath();
};
